...
"""
from sqlalchemy import Column, Integer, String, Date, DateTime, ForeignKey, Text, Boolean, func
...
class InterviewOutcome(Base):
    ...
    process_id = Column(Integer, ForeignKey("hirewire.interview_processes.id"), nullable=False, unique=True, index=True)
