...
class User(Base):
    ...
    is_airflow_admin = Column(
        Boolean, default=False
    )  # Only these users can access Airflow
    ...
    # Relationships
    interview_processes = relationship(
        "InterviewProcess", back_populates="user", cascade="all, delete-orphan"
    )
    ...
    profile_audit_logs = relationship(
        "ProfileAuditLog", back_populates="user", cascade="all, delete-orphan"
    )
